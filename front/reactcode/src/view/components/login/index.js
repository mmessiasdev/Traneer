    ...
    return (
        <>
                ...
                <form onSubmit={handleSubmit}>
                    <Box sx={{ maxWidth: "500px", height: "400px", bgcolor: "primary.main", display: "flex", alignItems: "center", justifyContent: "space-between", padding: {lg: "100px", xs: "100px 25px"}, borderRadius: "10px", flexDirection: "column" }}>
